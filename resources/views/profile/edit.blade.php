                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 text-center">
                            ...
                            @endphp
                            <img src="{{ $photoPath }}" alt="Foto Profil" class="rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                        </div>

                        {{-- Input Unggah Foto BARU --}}
                        <div class="mb-3">
                            <label for="profile_photo" class="form-label">Unggah Foto Profil Baru (Max 2MB)</label>
